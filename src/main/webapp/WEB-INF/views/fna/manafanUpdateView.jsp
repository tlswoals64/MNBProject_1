...
<body>
	...
	<div class="wrap">
		...
		<div class="content">
			<div id="deListB">FAQ 게시판</div>
			<form action="mFaqUpdate.do" method="post">
				<table class="qnaTable">
				<tr class="qnaTr" id="firstArea">
					<th class="qnaTh" id="typeArea">유형</th>
					<td class="qnaTd" id="type">
					<select id="faq_selectOption" name="fType">
							<option value="1">사이트 이용관련</option>
							<option value="2">회원정보</option>
							<option value="3">불건전 행위</option>
							<option value="4">기타</option>
							<option value="5">베이비시터 관련</option>
							<option value="6">부모님 관련</option>
						</select>
					</td>
				...
				<tr class="qnaTr" id="titleArea">
					...
					<td class="qnaTd" colspan="5"><input type="text" id="fTitle" name="fTitle" value="${ f.fTitle }"></td>
				</tr>
				...
				<tr class="qnaTr" id="contentArea">
					...
					<td class="qnaTd" colspan="5">
						<textarea class="qnaRely" rows="30" name="fContent" id="pReContent">${ f.fContent }</textarea>
					</td>
				</tr>
				...
				<div class="btnArea">
					<button type="submit" class="btn" id="applyBtn" onclick="alert('수정이 완료되었습니다.');">확인</button>
					<div class="btn" id="cancleBtn" onclick="location.href='mFaqList.do'">목록</div>
				</div>
		</form>
...
var check = "${ f.fType }";
console.log(check);
$('#faq_selectOption').val(check).prop('selected',true);
</script>

<script>
	function mFaQdelete(){
		if (confirm("정말 삭제하시겠습니까??") == true){    //확인
			location.href="mFaQdelete.do";
		}
	}
</script>
</html>