...
<body>
	...
	<div class="wrap">
		...
		<div class="content">
			...
			<form action="mFaqInsert.do" method="post">
				...
				<tr class="qnaTr" id="firstArea">
					...
					<td class="qnaTd" id="type">
						<select id="faq_selectOption" name="fType">
							...
							<option value="4">베이비시터 관련</option>
				...
				<tr class="qnaTr" id="titleArea">
					...
					<td class="qnaTd" colspan="5"><input type="text" id="fTitle" name="fTitle"></td>
				</tr>
				...
				<tr class="qnaTr" id="contentArea">
					...
					<td class="qnaTd" colspan="5">
						<textarea class="qnaRely" rows="30" name="fContent" id="pReContent">${ p.pReContent }</textarea>
					</td>
				</tr>
				...
				<div class="btnArea">
					...
					<div class="btn" id="cancleBtn" onclick="location.href='mFaqList.do'">취소</div>
				</div>
		</form>
