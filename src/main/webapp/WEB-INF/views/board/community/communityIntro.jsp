  ...
  <jsp:include page="../../common/header.jsp"></jsp:include>
	...
	<div class="boardchoose_wrap">
		<ul>
			...
			<li><a href="comListView.do"><img src="resources/images/board/communityIntro.png" width="500" height="550"><h5 style="position:absolute;top:633px;left:480px;font-size:20px;line-height:115%">커뮤니티바로가기</h5></a></li>
