...
#contents{width:1200px;margin:0 auto;padding:90px 0 0 0}
...
.sidebar li{padding:15px 20px ;border-bottom:1px solid #ddd ; border-top:1px solid #ddd}
.sidebar li:hover{cursor:pointer;font-weight:bold;color:#ee9a99}

.bbs{width:950px;float:right;overflow:hidden}
.btn{position:relative;width:1200px;margin:0 auto;bottom:0;clear:both}
.btn p{position:absolute;right:0;top:20px;text-align:right;text-align:center;}
.btn input[type="button"]{width:120px;height:38px;vertical-align:middle;background:#fff;border-radius:4px;border:1px solid #ddd}

.g_box{border:1px solid #ddd;width:278px;float:left;margin:0 55px 30px 0}
.g_box:last-child{margin-right:0}
.g_box p {height:190px}
.g_box p img{width:100%;height:190px}
.g_box h2{text-align:left;letter-spacing:0;margin:0 0 10px 0}
.g_box h3{font-weight:normal;color:#444;margin:0 0 30px 0}
.g_box ul{padding:20px;position:relative}
.g_box span{color:#b1a3ad;position:absolute;right:20px;bottom:20px}

.paging{clear:both;margin:30px 0 0 0}
.paging ul{text-align:center;}
.paging li{cursor:pointer;display:inline;border:1px solid #d3d5dc;text-align:center;color:#525367;padding:10px 12px;border-radius:3px}
.paging li.on{border:1px solid #525367;background:#525367;text-align:center;color:#fff}
.paging li:hover{border:1px solid #525367;background:#525367;text-align:center;color:#fff}

.search{text-align:center;margin:40px 0 0 0}
.search select{height:38px;vertical-align:middle}
.search input[type="text"]{height:34px;vertical-align:middle;padding:0 0 0 5px}
.search input[type="button"]{width:80px;height:38px;vertical-align:middle;}
 ...
 <body>
  ...
  <div id="contents">
	...
	<div class="bbs">
		<div class="g_box">
			<p><a href="dBoard.do"><img src="resources/images/main/header_bak_img.png"></a></p>
			<ul>
			<h2>안녕하세요</h2>
			<h3>최고관리자</h3>
			<span>등록일 : 19.01.01</span>
			</ul>
		</div>
		<div class="g_box">
			<p><img src="resources/images/main/header_bak_img.png"></p>
			<ul>
			<h2>안녕하세요</h2>
			<h3>최고관리자</h3>
			<span>등록일 : 19.01.01</span>
	...
	<div class="btn"><p><a href="inBoard.do"><input type="button" value="글쓰기"></a></p></div>
	...
	<div class="search">
		...
		</select> <input type="text" placeholder="검색어를 입력하세요"> <input type="button" value="검색">
	</div>
